...
//HL2MP
	...
	// HLVR animations
	REGISTER_SHARED_ACTIVITY( ACT_VM_HITDYNAMIC );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_RELEASE_DYNAMIC );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_IDLE_DYNAMIC );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_OPEN_DYNAMIC );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_FULL_DYNAMIC );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_EMPTY_DYNAMIC );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_INSERT_DYNAMIC );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_CLOSE_DYNAMIC );

	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_RELEASE );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_RELEASE_EMPTY );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_NOCLIP );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_NOCLIP_EMPTY );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_INSERT );
	REGISTER_SHARED_ACTIVITY( ACT_VM_RELOAD_INSERT_EMPTY );
	REGISTER_SHARED_ACTIVITY( ACT_VM_LASTFIRE );
