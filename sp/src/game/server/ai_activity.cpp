...
//===========================
	...
	// HLVR animations
	ADD_ACTIVITY_TO_SR( ACT_VM_HITDYNAMIC );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_RELEASE_DYNAMIC );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_IDLE_DYNAMIC );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_OPEN_DYNAMIC );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_FULL_DYNAMIC );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_EMPTY_DYNAMIC );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_INSERT_DYNAMIC );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_CLOSE_DYNAMIC );

	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_RELEASE );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_RELEASE_EMPTY );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_NOCLIP );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_NOCLIP_EMPTY );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_INSERT );
	ADD_ACTIVITY_TO_SR( ACT_VM_RELOAD_INSERT_EMPTY );
	ADD_ACTIVITY_TO_SR( ACT_VM_LASTFIRE );
